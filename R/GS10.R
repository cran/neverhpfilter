...
#'  \item\strong{Date Range:} {1953-04-01 to 2017-12-01}
#'  \item\strong{Last Updated} {2018-01-03 10:01 AM CST}
#' }
#'
#' @source Board of Governors of the Federal Reserve System (US) \url{https://fred.stlouisfed.org/data/GS10.txt}
#'
#' @examples
#' data(GS10)
#' tail(GS10)
